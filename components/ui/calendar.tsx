...
// Note: Changed to import from Button to match the actual file name
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-fore-2 rounded-md w-9 font-normal text-[0.8rem]",
        ...
        day_today: "bg-surface-2 text-fore",
        day_outside:
          "day-outside text-fore-2 opacity-50 aria-selected:bg-surface-2/50 aria-selected:text-fore-2 aria-selected:opacity-30",
        day_disabled: "text-fore-2 opacity-50",
        day_range_middle:
          "aria-selected:bg-surface-2 aria-selected:text-fore",

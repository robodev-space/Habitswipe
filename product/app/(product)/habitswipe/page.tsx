      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[0.9]">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-cyan-400 bg-clip-text text-transparent">a Simple Swipe.</span>
          </h1>
          ...
          <div className="mt-20 relative max-w-5xl mx-auto">
            <div className="aspect-[16/9] rounded-[2.5rem] border border-white/10 glass overflow-hidden shadow-[0_32px_128px_-16px_rgba(0,0,0,0.5)]">
               <div className="w-full h-full bg-zinc-950 flex items-center justify-center">
                  {/* Placeholder for an app screenshot or interactive demo */}
                  <div className="text-zinc-500 flex flex-col items-center gap-4">
                     ...
                     <span className="text-sm font-medium tracking-widest uppercase">Experience Focus</span>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 px-6 bg-zinc-950/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-6">Built for Consistency.</h2>
            <p className="text-zinc-500 max-w-xl mx-auto">Everything you need to transform your daily routine into a lifestyle.</p>
          </div>
            ...
            {[
              {
                ...
                description: "Done or skipped? One gesture is all it takes. The most rewarding interaction in productivity.",
                icon: Zap,
                color: "text-blue-400"
              },
              {
                title: "Visual Streaks",
                description: "Watch your progress grow with beautiful heatmaps and streak counters that keep you motivated.",
                icon: Trophy,
                color: "text-amber-400"
              },
              {
                title: "Deep Insights",
                description: "Understand your patterns with weekly reports and productivity charts.",
                icon: BarChart3,
                color: "text-emerald-400"
              },
              {
                title: "Smart Reminders",
                description: "Get nudged at the right time. Customize your notifications to fit your flow.",
                icon: Bell,
                color: "text-indigo-400"
              },
              {
                title: "Cross-Platform",
                description: "Track on your phone, tablet or desktop. Your habits are always with you.",
                icon: CheckCircle2,
                color: "text-cyan-400"
              },
              {
                 title: "Privacy First",
                 description: "Your data is yours. Secure, encrypted, and never sold. Focus on yourself.",
                 icon: Sparkles,
                 color: "text-purple-400"
              }
            ].map((f, i) => (
              <div key={i} className="p-8 rounded-3xl border border-white/5 bg-white/[0.02] hover:border-white/10 transition-colors">
